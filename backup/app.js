...
loader.load('/glb/UFOscene.glb',
    function (gltf) {
        ...
        UFOpositions = [
            ...
            {id: 'cow-about', position: UFOscene.getObjectByName('position_1').position, rotation: UFOscene.getObjectByName('position_1').rotation, cow: UFOscene.getObjectByName('cow1')},
            {id: 'cow-portfolio', position: UFOscene.getObjectByName('position_2').position, rotation: UFOscene.getObjectByName('position_2').rotation, cow: UFOscene.getObjectByName('cow2')},
            {id: 'cow-qualifications', position: UFOscene.getObjectByName('position_3').position, rotation: UFOscene.getObjectByName('position_3').rotation, cow: UFOscene.getObjectByName('cow3')},
            {id: 'cow-service', position: UFOscene.getObjectByName('position_4').position, rotation: UFOscene.getObjectByName('position_4').rotation, cow: UFOscene.getObjectByName('cow4')}
        ]
        
        scene.add(UFOscene);

        // cows
        // UFOscene.getObjectByName('cow1').position.set(-5.02057, 0.9, 0);
        // UFOscene.getObjectByName('cow2').position.set(-4, -2, 0.);
//         UFOscene.getObjectByName('cow3').position.set(-0.5292, 0.3596, 0.2499);
//         UFOscene.getObjectByName('cow4').position.set(-0.5292, 0.3596, 0.2499);
// 0.2499
...
function moveUFOTo(newCoordinates, onComplete) {
    ...
    console.log('Moving UFO to:', newCoordinates.position);
